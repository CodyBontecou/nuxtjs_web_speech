  ...
  <div class="w-full h-screen p-6 bg-blue-700">
    ...
    <div class="flex justify-around">
      <div class="absolute m-5 lg:my-16 lg:mx-8 left-0 bottom-0">
        <select class="p-3 lg:p-10 text-center text-sm rounded-lg shadow-lg bg-indigo-500 text-white uppercase tracking-wider font-semibold cursor-pointer">
        </select>
      </div>

      <div class="absolute m-5 lg:my-16 lg:mx-8 right-0 bottom-0">
        <a id="begin" data-cy="begin_button"
